...
export const metadata: Metadata = {
  ...
  description:
    "Master real Spanish with a specialized Mexican teacher for advanced students who want to perfect their fluency, precision, and natural expression.",
  openGraph: {
    title: "Advanced Spanish Classes with Belén Martínez",
    description:
      "Master real Spanish with a specialized Mexican teacher for advanced students who want to perfect their fluency, precision, and natural expression.",
      ...
      <div className="max-w-[880px] mx-auto px-4 py-8 pb-12">
        <header className="text-left mb-8">
          ...
          <p className="text-base text-gray-400 max-w-[600px]">
            Master real Spanish with a specialized teacher for advanced students
            who want to perfect their fluency, precision, and natural
            expression.
          </p>
          ...
          <div className="mt-6 grid md:grid-cols-[2fr_1.6fr] gap-5 items-center p-5 rounded-2xl bg-gradient-to-br from-slate-800/95 to-slate-800/80 border border-slate-600/30">
            <div className="text-sm">
              <p>
                <strong className="font-semibold">Write to me:</strong> WhatsApp
                only — no SMS
                <br />
        ...
        <main className="mt-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col md:flex-row gap-5 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm mb-2">
                  I'm a Mexican Spanish teacher with more than five years of
                  experience teaching advanced students from all over the world.
                </p>
                ...
                <ul className="ml-5 mt-1.5 mb-1 list-disc text-sm space-y-1">
                  ...
                  <li>
                    Preparation for interviews, presentations, and real-life
                    situations
                  </li>
                </ul>
                <p className="text-sm">
          ...
          <section className="rounded-2xl bg-slate-800/90 border border-slate-700 p-5">
            ...
            <p className="text-sm mb-2">
              Fully personalized sessions focused on your real goals:
              conversation, advanced grammar, final corrections, natural
              language use, professional Spanish, and more.
            </p>
            <ul className="ml-5 mt-1.5 mb-1 list-disc text-sm space-y-1">
              <li>
                Detailed corrections, clear explanations, and exercises adapted
                to your learning style
              </li>
              <li>
                Exclusive materials (audio, exercises, interactive practice)
              </li>
              <li>
                Constant follow-up: personalized study plan and homework
                designed just for you
              </li>
              <li>
                A clear, structured, and proven method, built over years of
                helping advanced students "break the ceiling" of their Spanish
              </li>
            </ul>
            <p className="text-sm">
              These classes are designed for students who truly want to reach
              the next level and value professional, deep, and personalized
              support.
            </p>
          </section>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <section className="rounded-2xl bg-slate-800/90 border border-slate-700 p-5">
              <h2 className="text-lg font-semibold mb-2.5">
                These classes are NOT for you if…
              </h2>
              <ul className="ml-5 list-disc text-sm space-y-1">
                <li>You're starting from zero</li>
                <li>
                  You only want casual conversation without guidance or
                  corrections
                </li>
                <li>
                  You don't plan to commit to homework or ongoing practice
                </li>
              </ul>
            </section>
          </div>
          ...
          <section className="rounded-2xl bg-slate-800/90 border border-slate-700 p-5">
            ...
            <ul className="ml-5 list-disc text-sm space-y-1">
              ...
              <li>
                Materials included (PDFs, audios, transcripts, corrections,
                extra practices)
              </li>
            </ul>
          </section>
          ...
          <section className="rounded-2xl bg-slate-800/90 border border-slate-700 p-5 text-left">
            <h2 className="text-lg font-semibold mb-2.5">
              Do you want 1:1 classes with me?
            </h2>
            <p className="text-sm mb-2">
