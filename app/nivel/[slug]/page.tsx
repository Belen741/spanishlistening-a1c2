...
export async function generateStaticParams() {
  ...
  // A1, A2, B1, B2, C1, C2 have custom routes, so exclude them
  return LEVELS
    .filter(level => !['a1', 'a2', 'b1', 'b2', 'c1', 'c2'].includes(level.slug))
    .map((level) => ({
      slug: level.slug,
    }));
}
...
export default async function LevelPage({
  ...
  // Redirect A1, A2, B1, B2, C1, and C2 to their custom URLs
  if (params.slug === 'a1') {
